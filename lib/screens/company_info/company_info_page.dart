...
class CompanyInfoPage extends StatefulWidget {
  CompanyInfoPage({
    super.key, required this.viewModelModel,
  });

  final CompanyViewModel viewModelModel;
...
class _CompanyInfoPageState extends State<CompanyInfoPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ChangeNotifierProvider.value(value: widget.viewModelModel,builder: (context, child){
